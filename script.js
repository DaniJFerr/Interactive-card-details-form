...
//       // Check if all fields are filled in and meet the requirements
...
//       const isValidCardNumber = cardNumberInput.value.length === 16 && !isNaN(cardNumberInput.value.trim());
//       const isValidMonth = dateCardCvcInputs[0].value !== '';
//       const isValidYear = dateCardCvcInputs[1].value !== '';
//       const isValidCVC = dateCardCvcInputs[2].value !== '' && dateCardCvcInputs[2].value.length === 3;

//         // Handle input errors or restore original style
//         if (cardNameInput.value === '' || cardNumberInput.value === '' || dateCardCvcInputs[0].value === '' || dateCardCvcInputs[1].value === '' || dateCardCvcInputs[2].value === '' || !isValidCardName || !isValidCardNumber || !isValidMonth || !isValidYear || !isValidCVC) {
...
//           handleInputError(cardNumberInput, 'Please fill in the card number with 16 digits.');
